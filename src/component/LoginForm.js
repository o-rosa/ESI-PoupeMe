    ...
    return (
        <form onSubmit={submitHandler}>
            <div className='form-inner corpo'>
                ...
                <div className='botao'>
                    <input type="submit" value="LOGIN" className='botaoEstilo'/> 
                    <div className='botaoEstilo btngoogle' onClick={actionLoginGoogle}> <p className='googleTexto'>LOGIN COM GOOGLE</p> </div><br />
