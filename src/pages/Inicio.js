...
const Inicio = (props) => {
    ...
    return (   
        <div className="App">
            ...
            <Link to="/login"> <div className="iniciar"><span className="spanNone">&nbsp;&nbsp; INICIAR</span><span className="spanHover">&nbsp;&nbsp; INICIAR</span><FontAwesomeIcon icon={faArrowRight} className="doneteIcon"/></div></Link>
